/*
 * Copyright (C) 2014 Vanir Heavy Metal Android Project
 *
...
import com.vanir.filemanager.console.Console;
import com.vanir.filemanager.console.ConsoleAllocException;
import com.vanir.filemanager.console.ConsoleBuilder;
import com.vanir.filemanager.console.ConsoleHolder;
import com.vanir.filemanager.console.shell.PrivilegedConsole;
import com.vanir.filemanager.preferences.AccessMode;
import com.vanir.filemanager.preferences.FileManagerSettings;
import com.vanir.filemanager.preferences.ObjectStringIdentifier;
import com.vanir.filemanager.preferences.Preferences;
import com.vanir.filemanager.ui.ThemeManager;
import com.vanir.filemanager.ui.ThemeManager.Theme;
import com.vanir.filemanager.util.AIDHelper;
import com.vanir.filemanager.util.AndroidHelper;
import com.vanir.filemanager.util.MimeTypeHelper;
...
public final class FileManagerApplication extends Application {
     ...
     * @hide
     */
    public static final String MAIN_PROCESS = "com.vanir.filemanager"; //$NON-NLS-1$
